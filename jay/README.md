...
## 🎯 학습 목적
단순히 데이터베이스를 사용하는 수준 아니라 실무에서 발생할 수 있는 데이터베이스 성능 문제를 이해하고 해결할 수 있는 능력을 기른다.

### Step1. Real MySQL 1권 딥다이브

#### 📖 학습내용: [Real My SQL 1권 정리](https://www.notion.so/Real-My-SQL-1-362f49fb6e0c806c8cd3ee04fa2560ff?source=copy_link)
